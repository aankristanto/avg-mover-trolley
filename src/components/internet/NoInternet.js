...
const NoInternet = () => {
  return (
    <div className="no-internet-container">
      <img src="https://t90181568181.p.clickup-attachments.com/t90181568181/21f8283a-6a22-4fd3-a0a4-c2927e4c4652/no-internet-connection-illustration-svg-download-png-5875082.webp?view=open" className='no-internet-img' />
